...
# API Keys
# Gemini puede tener hasta 3 claves para rotar cuota
GEMINI_API_KEY_1 = os.getenv('GEMINI_API_KEY', os.getenv('GEMINI_API_KEY_1', ''))
GEMINI_API_KEY_2 = os.getenv('GEMINI_API_KEY_2', '')
GEMINI_API_KEY_3 = os.getenv('GEMINI_API_KEY_3', '')

# Lista de claves válidas (filtrar vacías)
